<div class="row">
    <div class="col-xl-12">
        ...
        <form action="<?php echo BASE_URL.'categories/edit_action/'?><?php echo $catInfo['id']?>" method="POST">
            <div class="hk-pg-header">
                <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="archive"></i></span></span>Editar Categorias</h4>
                    ...
                    <?php endif;?>
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group has-error">
                                ...
                                <input type="text" class="form-control" value="<?php echo $catInfo['name'];?>" name="name" id="group_nome">
                            </div>
                        </div>
