<div class="row">
    <div class="col-xl-12">
        ...
        <form action="<?php echo BASE_URL.'permissao/add_action'?>" method="POST">
            <div class="hk-pg-header">
                <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="archive"></i></span></span>+ Grupos</h4>
                    ...
                    <?php endif;?>
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group has-error">
                                ...
                                <input type="text" class="form-control" name="nome" id="group_nome">
                            </div>
                        </div>
                        <?php foreach($permissao_itens as $item):?>
                            <div class="custom-control custom-checkbox">
                                <input class="custom-control-input" id="item-<?php echo $item['id']?>" type="checkbox" value="<?php echo $item['id']?>" name="itens[]">
