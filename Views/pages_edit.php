    ...
    <div class="col-xl-12">
        ...
        <form action="<?php echo BASE_URL.'pages/edit_action/'?><?php echo $info['id']; ?>" method="POST">
            <div class="hk-pg-header">
                <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="archive"></i></span></span>Editar Página</h4>
                    ...
                    <?php endif;?>
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group has-error">
                                ...
                                <input type="text" class="form-control" value="<?php echo utf8_encode($info['title']); ?>" name="title" id="page_title">
                            </div>
                        </div>                                              
                         ...
                         <div class="row">
                            <div class="col-md-12 form-group has-error">
                                ...
                                <textarea name="body" id="page_body" cols="30" rows="10">
                                <?php echo trim($info['body']); ?>
                                </textarea>
                            </div>
                        </div>        
