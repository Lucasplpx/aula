    ...
    <div class="col-xl-12">
        ...
        <form action="<?php echo BASE_URL.'options/add_action'?>" method="POST">
            <div class="hk-pg-header">
                <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="archive"></i></span></span>+ Opções</h4>
                <input type="submit" class="btn btn-gradient-primary btn-rounded" value="Salvar">
            </div>
            <div class="row">
                <div class="col-sm">
                    <?php if(!empty(in_array('name', $errorName))):?>
                    ...
                    <?php endif;?>
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group has-error">
                                <label for="group_nome">Nome da Opção</label>
